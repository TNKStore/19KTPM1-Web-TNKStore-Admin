...
CREATE TABLE `admin` (
  ...
  `last_name` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
...
INSERT INTO `admin` VALUES ('admin1912@gmail.com','Khue','Pham','$2b$10$reUntgyX4CxUJyUDCCQrbOzJV1lQyWbA0Pn0JT/lc5rQNGwqR0Lfy',0),('asd@gmail.com','','','$2b$10$mECDci7w1xBHMhN37RZyfeiPGcl1A4fq0CPNyTpeLO7K1.3KpyxEi',0);
...
INSERT INTO `bill` VALUES (1,2,'190 Cao Lỗ, Quận 8, TP. Hồ Chí M\'inh',1,19120100,3,'0822525450'),(2,2,'227 Nguyễn Văn Cừ, Quận 5, TP. Hồ Chí Minh',1,22750000,4,'0822525450'),(3,2,'227 Nguyễn Văn Cừ, Quận 5, TP. Hồ Chí Minh',1,19563500,2,'0822525450'),(4,2,'56 Vũ Ngọc Phan, Phan Thiết, Bình Thuận',3,703000,3,'0822525450');
...
INSERT INTO `billdetail` VALUES (1,4,1),(1,10,1),(2,6,5),(3,8,2),(4,12,1),(4,13,1);
...
CREATE TABLE `cartdetail` (
  ...
  `unauth_id` varchar(16) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
...
INSERT INTO `catalog` VALUES (1,'Laptop Asus'),(2,'Laptop Acer'),(3,'Laptop Dell'),(4,'Laptop MSI'),(5,'Chuột & lót chuột'),(6,'Bàn phím'),(7,'Tai nghe Gaming'),(8,'Loa & tai nghe');
...
CREATE TABLE `image` (
  ...
  `url` varchar(200) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user` (
  ...
  `activationString` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2022-01-09 19:59:46
